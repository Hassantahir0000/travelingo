...
export default function TravelInfoCards() {
  ...
  return (
    <motion.section
      ...
      viewport={{ amount: 0.2 }}
      className="w-screen z-[100]   shadow-[0px_0px_50px_rgba(255,_255,_255,_0.46)] h-auto bg-pale-cyan px-12 pt-[3rem] pb-[20rem] mt-[-1rem] rounded-tl-[3rem] rounded-tr-[3rem] "
    >
      <div className="container mx-auto">
        <div className="w-full">
          <motion.h2
            variants={animation(0)}
            className="self-stretch font-poppinsM text-black text-[4.25rem] font-normal  leading-normal"
          >
            Travel Info
          </motion.h2>
