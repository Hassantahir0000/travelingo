        ...
        <div className="flex  flex-row mx-auto justify-between items-center w-full h-full my-auto pb-[7rem] pt-[2rem]">
          <div className="w-[50%]">
            <motion.h2
              ...
              className="self-stretch font-poppinsM text-black text-[4.25rem]  leading-[5rem]"
            >
            ...
            <motion.p
              ...
              className="self-stretch  text-black text-[2.5rem] mt-3  font-poppinsR ml-4"
            >
              Features
            </motion.p>
            ...
            <div className="ml-8 mt-5">
              <motion.p
                ...
                className="self-stretch  text-black text-[1.4rem] w-[90%]  font-poppinsR   mt-1"
              >
            ...
            <motion.button
              ...
              className="border-2 border-black rounded-full px-6 w-[30rem] items-center gap-x-5 py-3 mt-[3rem]  text-black flex justify-between"
            >
