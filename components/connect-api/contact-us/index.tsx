...
export default function ContactUs() {
  return (
    <div className="w-screen centralise min-h-screen px-10 contact_us_container h-auto bg-maya-blue  pt-2 pb-[20rem] mt-[-4rem] rounded-tl-[3rem] rounded-tr-[3rem]">
      <div className="container max_width_container mx-auto">
        ...
        <div className="flex flex-col mt-[4rem] contact_us_panel bg-white px-10 py-[4rem] rounded-[30px] gap-y-5">
          <input
            className="px-4 py-5 ps-6 bg-blue-blur/50 text-white text-[1.5rem] rounded-[40px] font-poppinsR placeholder:text-white"
            type="text"
            placeholder="Name"
          />
