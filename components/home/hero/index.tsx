    ...
    <div className="w-screen h-screen centralise">
      ...
      <div className="flex justify-center items-center ">
        <motion.div
          ...
          className="container max_width_container bg-blue-blur/50 absolute bottom-[10rem] banner_first_panel py-[1.875rem] px-[2.75rem] rounded-[30px] backdrop-blur-[0.5rem] md:w-[90%] block mx-auto"
        >
        ...
        <motion.div
          ...
          className="container max_width_container bg-blue-blur/50 banner_second_panel absolute items-center  bottom-10 py-5 px-[1.75rem] rounded-full backdrop-blur-[0.5rem] md:w-[90%] block mx-auto"
        >
