    ...
    <div className="  bg-blue-blur/50  absolute top-0 py-[1.875rem] px-[2.75rem]  backdrop-blur-[0.5rem] w-screen block mx-auto">
      <div className="wrapper flex  items-center justify-between">
        ...
        <div className="flex gap-x-5">
          <button className="border-2 border-white flex rounded-[40px] transition-all p-3 items-center hover:bg-light-sky-blue hover:delay-100">
            <Image
          ...
          <Link
            href={"/connect-api"}
            className="border-2 border-white flex rounded-[40px] transition-all px-10 py-3 items-center hover:bg-light-sky-blue hover:delay-100"
          >
            <p className="font-poppinsR text-white">Traveling API</p>
          </Link>
