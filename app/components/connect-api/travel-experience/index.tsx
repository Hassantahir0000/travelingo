  ...
  return (
    <div className="w-screen z-[100]   shadow-[0px_0px_50px_rgba(255,_255,_255,_0.46)] h-auto bg-pale-cyan px-12 py-[6rem] mt-[-8rem] rounded-tl-[3%] rounded-tr-[3%] ">
      <div className="flex flex-row justify-between items-center w-full h-full my-auto pb-[7rem] pt-[4rem]">
        <div className="w-[50%]">
          <h2 className="self-stretch  text-black text-[4.25rem] mt-[68px]  font-normal  leading-[5rem] ">
            Unlock Seamless <br></br> Travel Experiences
          </h2>

          <p className="self-stretch  text-black text-[2.5rem] mt-3  font-normal ml-4">
            Features
          </p>

          <div className="ml-8 mt-5">
            <p className="self-stretch  text-black text-[1.4rem] w-[90%]  font-normal   mt-1">
          ...
          <button className="border-2 border-black rounded-full px-6 w-[30rem] items-center gap-x-5 py-3 mt-[3rem]  text-black flex justify-between">
            <p className="text-black text-[1.5rem]">Request a Demo</p>
